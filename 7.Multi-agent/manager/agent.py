...
root_agent = Agent(
    ...
    **DELEGATION WORKFLOW:**
    1. When delegating to a sub-agent, ALWAYS use track_agent_delegation first
    2. Use appropriate tools to update user preferences based on their requests
    3. Provide personalized responses based on stored preferences
    4. Track user interactions to improve future responses
